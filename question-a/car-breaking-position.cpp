 ...
 * 
 * \param car_position_data Contains a sequence of numbers (at least one) that represents position of the car sampled
 * at consequitive time intervals. The car could be decelerating from the start or could be accelerating till the end.
 * 
...
{
  return car_position_data.front();
}
